...
// ---------------------------------------------------------------------
// Datenmodell + Parser fuer /etc/passwd und /etc/group. Beides ist
// world-readable, also ganz normal unprivilegiert lesbar -- anders als
...
enum NodeKind { NK_NONE, NK_USERS, NK_GROUPS };
